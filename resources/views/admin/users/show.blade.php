                ...
                <div class="profile-header">
                    <div class="row align-items-center">
                        ...
                        <div class="col ml-md-n2 profile-user-info">
                            ...
                            <h6 class="text-muted mt-1">{{ $user->role }}</h6>
                            <div class="user-Location mt-1"><i class="fas fa-map-marker-alt"></i> Bandung, Indonesia
                            </div>
                            <div class="about-text">{{ $user->user_description }}</div>
                        </div>
                        <div class="col-auto profile-btn"> <a href="{{ route('user.edit',$user->id) }}"
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mt-5">
                                            <p class="col-sm-2 text-sm-left mb-0 mb-sm-3">Name</p>
                                            <p class="col-sm-10">{{ $user->username }}</p>
                                        </div>
                                        <div class="row">
                                            <p class="col-sm-2 text-sm-left mb-0 mb-sm-3">Email</p>
                                            <p class="col-sm-10">{{ $user->email }}</p>
                                        </div>
                                        <div class="row">
                                            <p class="col-sm-2 text-sm-left mb-0 mb-sm-3">Deskripsi</p>
                                            <p class="col-sm-10">{{ $user->user_description }}</p>
                                        </div>
                                    </div>
                                </div>
